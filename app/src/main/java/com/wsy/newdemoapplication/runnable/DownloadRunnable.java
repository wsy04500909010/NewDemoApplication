package com.wsy.newdemoapplication.runnable;
...
/**
 * Created by WangSiYe on 2019/1/18.
 */
public class DownloadRunnable implements Runnable {

    private DownloadHelpBean info;//下载信息JavaBean
     ...
     * @param info 任务信息
     */
    public DownloadRunnable(DownloadHelpBean info) {
        this.info = info;
    }
